module ApplicationHelper
  ...
  def get_location_color
    ["bg-slate-50", "bg-slate-100", "bg-slate-200", "bg-slate-300", "bg-slate-400", "bg-gray-50",
      ...
      "bg-neutral-600", "bg-stone-50", "bg-stone-100", "bg-stone-200", "bg-stone-300", "bg-stone-400", "bg-red-50", "bg-red-100",
      ...
      "bg-green-500", "bg-emerald-50", "bg-emerald-100", "bg-emerald-200", "bg-emerald-300", "bg-emerald-400", "bg-emerald-500", "bg-emerald-600",
